...
('tic-tac-toe','images/tictactoe.png',"Why can one artist never beat another artist at tic tac toe? They always end up drawing"),
...
('connectgit four', 'images/connectfour.png',"The winner is the first to line up four numbers with a common factor.");
commit;
